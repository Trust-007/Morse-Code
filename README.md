...
> Morse-Code is our first project in ruby programming language and it convert morse message to human readable message.

**Morse-Code** is the ruby methods project that convert morse messages.
...
- mkdir my-folder
- cd my-folder
- git clone [(https://github.com/Trust-007/Morse-Code.git)]
...
Feel free to check the [issues page](https://github.com/Trust-007/Morse-Code/issues).
...
This project is [MIT](https://github.com/Trust-007/Morse-Code/blob/decode-morse/MIT.md) licensed.
